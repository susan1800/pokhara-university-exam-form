    ...
    <div class="container">
        <div class="screen">
            ...
            <div class="screen__content">
                <form class="login" method="post" action="{{route('forgotpassword.change')}}">
                    @csrf
                    <div class="login__field">
                        ...
                        <p id="passwordresult" style="color:red; font-size:0.8em;"></p>
                        <input type="password" class="login__input" id="confirmpassword" placeholder="Confirm password" onkeyup="checkpassword()" required>
