        ...
        <form>
            ...
            <div class="signature" style="margin-top:2%; margin-right:0%;">
                ...
                <div class="col1" style="float: left;;width: 60%; ">
                    <p>signature of the student : <img src=" @if(($formdata->signature != "")||($formdata->signature != null)){{asset('storage/'.$formdata->signature)}}@endif  @if(($formdata->signature_imag != "")||($formdata->signature_image != null)){{asset('storage/'.$formdata->signature_image)}}@endif" width="120" height="40"></p>
