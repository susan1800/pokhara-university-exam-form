        ...
        <div class="mb-2 border-solid border-gray-300 rounded border shadow-sm w-full">
            <div class="bg-gray-200 px-2 py-3 border-solid border-gray-200 border-b">
                <nav class="navbar navbar-dark bg-dark">
                    <a href="{{route('admin.subject.create')}}"><button class=" btn btn-primary" type="button">
                     Add Subject
                    </button>
                    </a>
                    {{-- <div></div> --}}
        ...
        tr[i].style.display = "none";
            ...
            <div class="p-3">
                ...
                <table class="table-responsive w-full rounded" >
                    <thead>
                        <tr>
                            <th class="border w-1/4 px-4 py-2">Subject Code</th>
                            <th class="border w-1/7 px-4 py-2">Subject Title</th>
                            <th class="border w-1/5 px-4 py-2">Credit</th>
                            <th class="border w-1/5 px-4 py-2">Program</th>
                            <th class="border w-1/5 px-4 py-2">Level</th>
                            <th class="border w-1/5 px-4 py-2">Course Year</th>
